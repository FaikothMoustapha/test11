    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('store_ecole')}}">
                    @csrf
                
                    <div   class="form-group col-lg-3  " >
                        <label for="inputText3" class="col-form-label">Code de l'Etablissement</label>
                        <input id="inputText3" type="text" class="form-control" name="codEcole" >
                    ...
                    <div   class="form-group col-lg-12  " >
                        ...
                        <input id="inputText3" type="text" class="form-control" name="nomEcole">
